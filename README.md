...
[Report d'incidente INC-2026-0042 »](Report_Incidente_INC-2026-0042.pdf) · [Playbook Pass-the-Hash »](Playbook_PtH_PB-PTH-001.pdf)
...
I documenti completi del progetto sono disponibili in questo repository:

- [Portfolio completo »](Portfolio_Completo.pdf) — il progetto integrale, con tutti gli scenari, le evidenze e la copertura MITRE ATT&CK.
- [Sintesi (1 pagina) »](Sintesi_Portfolio.pdf) — panoramica rapida del lab e delle competenze.
- [Report d'incidente INC-2026-0042 »](Report_Incidente_INC-2026-0042.pdf) — report formale in stile SOC sullo scenario Pass-the-Hash.
- [Playbook Pass-the-Hash »](Playbook_PtH_PB-PTH-001.pdf) — playbook di detection & response per il lateral movement via PsExec.
